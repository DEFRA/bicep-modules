...
| `virtualNetworkPeerings`                | `array`  | No       | Optional. Virtual Network Peerings configurations. Please refer to the [virtualNetworkPeerings](virtualNetworkPeerings/readme.md) readme                                                                                                                                                                                                                                                                       |
